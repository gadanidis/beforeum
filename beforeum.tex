...
its dramatic rise.
Like \textcite{fruehwald2016}, we do not find that position meaningfully
constrains the choice of \emph{um} vs.\ \emph{uh}.
We do find that for a few of the younger farmers, % TODO: check how many
\emph{um} appears more frequent than \emph{uh} in initial position, with a
similar pattern apparent with the much younger interviewers.
This is suggestive, but not definitive, given the low number of speakers
involved.
