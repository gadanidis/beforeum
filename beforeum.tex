...
This study highlights the importance of viewing discourse-pragmatic variation
...
\emph{um} is emerging, but relative frequency data indicate that the relevant
change is actually one that we hadn't considered, and one that falls outside our
original envelope of variation: a change from unfilled pauses
to \emph{uh}.
